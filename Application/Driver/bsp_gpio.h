#ifndef BSP_GPIO__H__
#define BSP_GPIO__H__
...
#define LED_GREEN_TOGGLE()	(HAL_GPIO_TogglePin(LED_G_GPIO_Port, LED_G_Pin))
...
#define LED_BLUE_TOGGLE()	(HAL_GPIO_TogglePin(LED_B_GPIO_Port, LED_B_Pin))


extern void Bsp_GPIO_EXTI_Handler(uint16_t GPIO_Pin);
